...
{
	return read_adc(battServiceAdcCh, HAL_ADC_RESOLUTION_10, HAL_ADC_REF_125V);
}
...
float ther_batt_get_voltage(void)
{
	...
	voltage = ther_batt_get_adc() * 3.75 / 511;
 ...
 * For AT command
 */
unsigned char ther_batt_get_raw_percentage(void)
{
	return battServiceCalcCB(ther_batt_get_adc());
}
