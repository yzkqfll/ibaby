...
static uint8 devInfoFirmwareRev[FW_STRING_LEN] = "Firmware Revision";
...
static const uint8 devInfoMfrName[] = "59089403@qq.com";
...
//        *pLen = MIN(maxLen, ((sizeof(devInfoFirmwareRev) - 1) - offset));
        *pLen = MIN(maxLen, strlen((const char *)devInfoFirmwareRev));
        // copy data
